        ...
        <div class="color-info">
          ...
          <div class="color-actions" data-tour="color-actions">
            ...
            <Tooltip text="手动调节该颜色" position="top">
              <button class="edit-btn" @click.stop="emitPickColor(index)"><IconEdit2 size="18" /></button>
            </Tooltip>
            <Tooltip text="AI调节该颜色" position="top">
              <button class="pick-btn" @click.stop="emitSelectColor(index)"><IconCheckCircle size="18" /></button>
            </Tooltip>
          </div>
        </div>
        <!-- 对比差值显示 -->
